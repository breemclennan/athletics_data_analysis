...
wrk.03DataTrans_Q1D <- wrk.03DataTrans_03 %>%
  ...
  summarise(NUMAthletesParticipated = n_distinct(KEYRegistrationNumber)) %>%
  arrange(desc(NUMAthletesParticipated))
 
wrk.03DataTrans_Q1DD <- wrk.03DataTrans_Q1D %>%
  #mutate(NUMAthletesParticipated = color_bar("lightblue")(NUMAthletesParticipated)) %>%
